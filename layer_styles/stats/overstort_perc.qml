...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="<<variable>>" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
      ...
      <range render="true" symbol="2" lower="5" upper="100" label="5 - 101"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="2">
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@2@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="253,211,153,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="square"/>
              <prop k="offset" v="0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="3">
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@3@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="252,166,108,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="square"/>
              <prop k="offset" v="0,0"/>
    ...
    <labelformat format=" %1 - %2 " trimtrailingzeroes="false" decimalplaces="6"/>
  </renderer-v2>
  ...
  <aliases>
    <alias field="a.id" index="0" name=""/>
    <alias field="h_start_value" index="1" name=""/>
    <alias field="h_end_value" index="2" name=""/>
    <alias field="a.crest_level" index="3" name=""/>
    <alias field="diff_start" index="4" name=""/>
    <alias field="diff_end" index="5" name=""/>
    <alias field="c.external" index="6" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="a.id"/>
      <column width="-1" hidden="0" type="field" name="h_start_value"/>
      <column width="-1" hidden="0" type="field" name="h_end_value"/>
      <column width="-1" hidden="0" type="field" name="a.crest_level"/>
      <column width="-1" hidden="0" type="field" name="diff_start"/>
      <column width="-1" hidden="0" type="field" name="diff_end"/>
      <column width="-1" hidden="0" type="field" name="c.external"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <previewExpression>COALESCE( "a.id", '&lt;NULL>' )</previewExpression>
